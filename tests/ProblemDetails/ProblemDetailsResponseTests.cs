...
public class ProblemDetailsResponseTests
{
    ...
    public void CustomMessage()
    {
        // Arrange
        var statusCode = 400;
        var errorMessage = "invalid request with this operation";
        var expectedStatusCode = 400;
        var type = StatusCodeLink.BAD_REQUEST;


        // Act
        var act = ProblemDetailsResponse.Create(statusCode, errorMessage);
    ...
    public void HttpContext_500()
    {
        ...
        // Arrange
        var act = ProblemDetailsResponse.Create(httpContext);
    ...
    public void ModelState_NULL()
    {
        ...
        // Act
        var act = ProblemDetailsResponse.Create(httpContext, modelState);
    ...
    public void ActionContext_InternalError()
    {
        ...
        // Act
        var act = ProblemDetailsResponse.Create(actionContext);
    ...
    public void ActionContext_Create()
    {
        ...
        var expectedInstance = "GET: users/photos";
        var expectedErrorMessage = "Not Found";
        var type = StatusCodeLink.NOT_FOUND;


        // Act
        var act = ProblemDetailsResponse.Create("get", "users/photos", 404);
